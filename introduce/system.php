...
<body>
		...
		<div class="container">
			<ol class="breadcrumb">
				...
				<li class="active dropdown">
					<a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">NCS분류체계<span class="caret"></span></a>
	...
	<main id="content" class="introduce system">
		<div class="container">
			<section class="system">
                ...
                <p>
                    <img src="/assets/images/introduce/system_table.jpg" alt="NCS분류체계">
                </p>
                <h4 class="subject"><span></span>국가직무능력표준의 분류번호</h4>
                <div class="classification">
                    <ul class="content-list">
                        <li>
                            <dl class="inline-dl">
                                <dt>대분류</dt>
                                <dd>대분류 체계의 2자리 숫자</dd>
                            </dl>
                        </li>
                        <li>
                            <dl class="inline-dl">
                                <dt>중분류</dt>
                                <dd>중분류 체계의 2자리 숫자</dd>
                            </dl>
                        </li>
                        <li>
                            <dl class="inline-dl">
                                <dt>소분류</dt>
                                <dd>소분류 체계의 2자리 숫자</dd>
                            </dl>
                        </li>
                        <li>
                            <dl class="inline-dl">
                                <dt>세분류</dt>
                                <dd>세대분류 체계의 2자리 숫자</dd>
                            </dl>
                        </li>
                        <li>
                            <dl class="inline-dl">
                    ...
                    <p>
                        <img src="/assets/images/introduce/system_number.jpg" alt="국가직무능력표준의 분류번호">
                    </p>
                </div>
			</section>
		</div>
