...
<body>
		...
		<div class="container">
			<ol class="breadcrumb">
				...
				<li class="active dropdown">
					<a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">뉴스/보도<span class="caret"></span></a>
	...
	<main id="content" class="community news">
		<div class="container">
			<section class="news">
                ...
                <ul class="news-list">
                    <li>
                        <a href="#">
                            <p>
                                <img src="/assets/images/community/news_img01.jpg" alt="뉴스이미지">
                            </p>
